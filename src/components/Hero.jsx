  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary/85 via-primary-light/75 to-primary/70" />
          ...
          <div className="w-full max-w-6xl">
            <div className="text-center flex flex-col items-center justify-center">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-4 md:mb-6 text-center px-4">
                ...
                <br />
                <span className="text-accent-light">Smart Agriculture</span>
              </h1>

              {/* Description */}
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 leading-relaxed mb-8 md:mb-12 max-w-4xl text-center px-4">
                Get real-time weather updates, market prices, government schemes, 
                and AI-powered farming advice all in one place. Join thousands of 
                farmers making informed decisions every day.
              </p>

              {/* Stats Grid */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 lg:gap-8 mb-8 md:mb-16 w-full justify-items-center px-4">
                {stats.map((stat, index) => (
                  <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 w-full">
                    <div className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-1 md:mb-2 text-center">
                      {stat.value}
                    </div>
                    <div className="text-xs md:text-sm lg:text-base text-white/90 font-medium text-center">
                      {stat.label}
                    </div>
                  </div>
                ))}
